<template>
  <el-dialog
    ...
    >
    <template #header>
      <slot name="title"><span class="title-text">{{ textMappingConfig.sphereActionSettings.chineseText + ' ' + textMappingConfig.sphereActionSettings.otherLanguagesText }}</span></slot>

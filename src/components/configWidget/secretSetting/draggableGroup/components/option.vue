<template>
  ...
  >
    ...
    <div class="related-txt" v-if="option.noCanSelected">{{ textMappingConfig.alreadyInWinnerListCannotUnassociate.chineseText + ' ' + textMappingConfig.alreadyInWinnerListCannotUnassociate.otherLanguagesText }}</div>
    <!-- 关闭按钮 -->
      <el-icon 
        class="close-btn" 
        :size="20"
